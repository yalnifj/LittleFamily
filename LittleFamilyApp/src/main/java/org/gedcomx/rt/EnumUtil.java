...
*/
   ...
   * @param clazz The enum clazz.
   * @return The matching enum, or the {XmlUnknownQNameEnumValue unknown enum} if unable to find an enum for the specified URI, or <code>null</code>
...
*/
   ...
   * @return The URI.
   * @throws IllegalArgumentException If <code>e</code> isn't of a valid QName enum type,
   * or if <code>e</code> is the {XmlUnknownQNameEnumValue unknown enum},
   * or if {org.codehaus.enunciate.qname.XmlQNameEnumValue#exclude() the enum is excluded as an enum value}.
   */

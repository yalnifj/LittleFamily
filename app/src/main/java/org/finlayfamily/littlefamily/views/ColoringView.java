...
import org.finlayfamily.littlefamily.imagefilters.LaplaceFilter;
 ...
 */
public class ColoringView extends ImageView {
    public int width;
    public  int height;
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        canvas.drawBitmap(outlineBitmap, 0, 0, mBitmapPaint);
    ...
    public void setImageBitmap(Bitmap bm)
    {
        ...
        outlineBitmap = Bitmap.createBitmap(bm);
        filter.filter(bm, outlineBitmap);
    }
